...
{{- printf "aws-lb" | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "aws-lb-%s" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- printf "%s-svc-%s-%s-aws-lb-wh-%s" .Values.k8sPrefix .Values.customer .Values.purpose .Values.stage -}}
{{- end -}}
