...
{{ include "newrelic.common.license._customSecretName" . | default (printf "%s-secret-%s-%s-%s-license-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "newrelic.common.naming.fullname" . ) .Values.stage) }}
{{- end -}}
