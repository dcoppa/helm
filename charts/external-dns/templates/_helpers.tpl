...
{{- printf "external-dns" | trunc 63 | trimSuffix "-" -}}
{{- else }}
{{- printf "external-dns-%s" $name | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
...
{{- default (printf "%s-sa-%s-%s-%s-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "external-dns.fullname" .) .Values.stage) .Values.serviceAccount.name }}
{{- else }}
