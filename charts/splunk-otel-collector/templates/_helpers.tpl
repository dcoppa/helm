...
{{- printf "splunk-otel-collector" | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "splunk-otel-collector-%s" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- default (printf "%s-secret-%s-%s-%s-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "splunk-otel-collector.fullname" .) .Values.stage) .Values.secret.name }}
{{- end -}}
...
{{- define "splunk-otel-collector.serviceAccountName" -}}
    {{ default (printf "%s-sa-%s-%s-%s-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "splunk-otel-collector.fullname" .) .Values.stage) .Values.serviceAccount.name }}
{{- end -}}
