...
{{- else -}}
    {{- printf "%s-cm-%s-%s-%s-cfg-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "common.names.fullname" .) .Values.stage -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s-secret-%s-%s-%s-%s" .Values.k8sPrefix .Values.customer .Values.purpose (include "common.names.fullname" .) .Values.stage -}}
{{- end -}}
{{- end -}}
